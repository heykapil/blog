...
const LayoutWrapper = ({ children }) => {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 z-40 bg-transparent overflow-x-hidden backdrop-blur supports-backdrop-blur:bg-white/95 py-3 sticky bg-white/75 dark:bg-dark/75">
