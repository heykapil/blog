...
const LayoutWrapper = ({ children }) => {
  ...
  return (
    <>
      ...
      <header className="backdrop-filter trasition ease-in-out duration-500 overflow-x-hidden backdrop-blur supports-backdrop-blur:bg-white/50 py-3 sticky top-0 z-40 bg-white/30 dark:bg-dark/50 bg-opacity-50 bg-dpattern dark:bg-pattern">
